...
public class MultRecordManager : MonoBehaviour
{
    //----------------------------------
    // VARIABLES
    //----------------------------------
    ...
    public MultTxtManager txtManager;
    ...
    public void deleteRecord()
    {
        ...
        //Txt file
        string deletefileTxt = string.Format("{0}/StreamingAssets/MultipleContainer/Reports/{1}",
                  UnityEngine.Application.dataPath, nombre.text);
        //PDF file
        string deletefilePdf = string.Format("{0}/StreamingAssets/MultipleContainer/pdf/{1}.pdf",
    ...
    public void printPdf()
    {
        ...
        string printFile = string.Format("{0}/StreamingAssets/MultipleContainer/pdf/{1}.pdf",
