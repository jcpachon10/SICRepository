...
public class MultTxtManager : MonoBehaviour
{
    public string path;
    ...
    {
        string path = string.Format("{0}/StreamingAssets/MultipleContainer/Reports/",
            UnityEngine.Application.dataPath);
        string pathPdf = string.Format("{0}/StreamingAssets/MultipleContainer/Reports/",
            UnityEngine.Application.dataPath);
        txt_quantity = 0;
