...
public class TwoStageRecordManager : MonoBehaviour
{//------------------------
 //VARIABLES
 //------------------------
 //----------------------------------
 ...
 //----------------------------------
    ...
    public TwoStageTxtManager txtManager;
    ...
    public void deleteRecord()
    {
        ...
        //Txt file
        string deletefileTxt = string.Format("{0}/StreamingAssets/TwoStage/Reports/{1}",
                  UnityEngine.Application.dataPath, nombre.text);
        //PDF file
        string deletefilePdf = string.Format("{0}/StreamingAssets/TwoStage/pdf/{1}.pdf",
    ...
    public void printPdf()
    {
        ...
        string printFile = string.Format("{0}//StreamingAssets/TwoStage/pdf/{1}.pdf",
