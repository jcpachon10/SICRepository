...
public class TwoStageTxtManager : MonoBehaviour
{
    public string path;
    ...
    void Start()
    {
        path = Application.dataPath + "/StreamingAssets/TwoStage/Reports/";
        pathPdf = Application.dataPath + "/StreamingAssets/TwoStage/pdf/";
