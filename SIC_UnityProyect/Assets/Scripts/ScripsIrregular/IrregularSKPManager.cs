...
public class IrregularSKPManager : MonoBehaviour
{
   //-----------------------
   ...
   //-----------------------
    ...
    public void runalgorim()
    {
        ...
        //startInfo.FileName = string.Format("{0}/StreamingAssets/OtherObjects/{1}",UnityEngine.Application.dataPath, "ProjectCplex.exe");
       ...
       string input = "-t 10 -ins prueba -Lx " + pm.containerSize.z*100 + " -Ly " + pm.containerSize.y*100 + " -Lz " + pm.containerSize.x * 100;
